...
<html>
 ...
 ?>
 <div class="col-md-4">
 <form method="post" action="winkel.php?action=add&id=<?php echo $row["id"]; ?>">
 ...
 <td><a href="winkel.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
 </tr>
 <?php
